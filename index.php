  ...
  <main class="mt-5">
    <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 gx-5 mb-4">
            <div class="bg-image hover-overlay ripple shadow-2-strong" data-mdb-ripple-color="light">
              <img src="./img/res.webp" class="img-fluid" />
              <a>
          ...
          <div class="col-md-6 gx-5 mb-4"><br>
            ...
            <p class="text-muted">
              La'eeb, la mascota de Qatar 2022, es la más reciente en los Mundiales de la FIFA.
            </p>
          </div>
        </div>
      </section>
      ...
      <section class="text-center">
        <h4 class="mb-5"><strong>Noticias</strong></h4>

        <div class="row">
          <div class="col-lg-4 col-md-12 mb-4">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/second.webp" width="780" height="520" class="img-fluid" />
                <a href="https://www.fifa.com/es/news/la-banda-de-messi-los-nombres-de-una-seleccion-que-suena-con-catar-2022">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15)"></div>
                </a>
              </div>
              <div class="card-body">
                <h5 class="card-title">La banda de Messi: los nombres de una Selección que sueña con Catar 2022</h5>
                <p class="card-text">
                  Copa Mundial de la FIFA Catar 2022&trade;
                </p>
                <a href="https://www.fifa.com/es/news/la-banda-de-messi-los-nombres-de-una-seleccion-que-suena-con-catar-2022" class="btn btn-primary">Ver</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/imagen.webp" width="780" height="520" class="img-fluid" />
                <a href="https://www.fifa.com/es/news/javier-mascherano-la-experiencia-convirtio-a-messi-en-un-jugador-total">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15)"></div>
                </a>
              </div>
              <div class="card-body">
                <h5 class="card-title">Javier Mascherano: “La experiencia convirtió a Messi en un jugador total”</h5>
                <p class="card-text">
                  Copa Mundial de la FIFA Catar 2022&trade;
                </p>
                <a href="https://www.fifa.com/es/news/javier-mascherano-la-experiencia-convirtio-a-messi-en-un-jugador-total" class="btn btn-primary">Ver</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="./img/third.webp" width="780" height="520" class="img-fluid" />
                <a href="https://www.fifa.com/es/news/living-football-el-congreso-el-sorteo-y-los-legados-del-mundial">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15)"></div>
                </a>
              </div>
              <div class="card-body">
                <h5 class="card-title">Living Football: el Congreso, el Sorteo y los legados del Mundial</h5>
                <p class="card-text">
                  Copa Mundial de la FIFA Catar 2022&trade;
                </p>
                <a href="https://www.fifa.com/es/news/living-football-el-congreso-el-sorteo-y-los-legados-del-mundial" class="btn btn-primary">Ver</a>
              </div>
            </div>
          </div>
        </div>
