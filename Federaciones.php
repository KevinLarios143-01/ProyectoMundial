        ...
        <div class="container">
            <section class="mb-5">
                ...
                <table class="table ">
                    ...
                    <tbody>
                        <?php
                        $query_estadios = "SELECT * FROM federacion l ORDER BY l.cod_federacion;";
                        ...
                        while ($line = pg_fetch_array($result_estadios)) {
                            $cod = $line['cod_federacion'];
                            $nombre = $line['nombre_federacion'];
                            echo "<tr>
                                        <th scope='row'>$cod</th>
                                        <td>$nombre</td>
                                    </tr>";
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-6">
                        <a name="ingresar"></a>
                        <h4 class="mb-5 text-center">
                            <strong>Ingresar Federacion</strong>
                        </h4>
            ...
            if (isset($_POST['agregar'])) {
                ...
                if ($trabajoono) {
                    $id_que_toca = "SELECT count(*) AS ids FROM federacion;";
                    $id = val_id($id_que_toca, $link);
                    $id++;
                    $query = "INSERT INTO federacion VALUES ($id,'$nombre_e');";
            ...
            function verificar_existencia($querys, $links)
            {
                ...
                if ($verify_exist > 0) {
                    $makeornos = false;
                    echo '<div class="alert alert-warning" role="alert">Esta federacion ya existe!</div>';
                } else {
                    $makeornos = true;
                }
                return $makeornos;
